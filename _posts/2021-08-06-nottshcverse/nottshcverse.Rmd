...
There are many challenges when working with healthcare data, here is only a small selection of those that I think underlay most analyses.
...
There will always be some messy data, inconsistent variable names, undocumented code, and ... blablabla.
